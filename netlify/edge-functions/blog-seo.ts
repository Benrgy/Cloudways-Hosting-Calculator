...
function generateSEOTags(post: BlogPost): string {
  const title = post.meta_title || `${post.title} - Cloudways Hosting Calculator`;
  const description = post.meta_description || post.excerpt || `Read "${post.title}" on Cloudways Hosting Calculator - expert insights and professional advice.`;
  const canonicalUrl = `https://benrgy.github.io/Cloudways-Hosting-Calculator/blog/${post.slug}`;
  ...
  return `
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "BlogPosting",
      "headline": "${escapeHtml(title.replace(' - Cloudways Hosting Calculator', ''))}",
      ...
      "author": {
        ...
        "url": "https://benrgy.github.io/Cloudways-Hosting-Calculator"
      },
      "publisher": {
        "@type": "Organization",
        "name": "Cloudways Hosting Calculator",
        "logo": {
          "@type": "ImageObject",
          "url": "https://benrgy.github.io/Cloudways-Hosting-Calculator/og-image.jpg"
        }
      },
      "mainEntityOfPage": {
        "@type": "WebPage",
